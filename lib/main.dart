            ...
            children: [
              ...
              Positioned(
                ...
                child: SizedBox(
                  ...
                  child: Center(
                    child: DragTarget(
                      onWillAcceptWithDetails: (data) => true, // Accept any dragged data
                      onAcceptWithDetails: (details) {
                        final droppedItem = details.data;
                        print('drop');
                        setState(() {
                          // Simply add the dropped item back to the list if not already present
                                ...
                                child: AnimatedScale(
                                  ...
                                  child: Padding(
                                    ...
                                    child: Draggable(
                                      ...
                                      onDragEnd: (details) {
                                        setState(() {
                                          if (draggedItem != null) {
                                            ...
                                            int droppedIndex = hoveredIndex > -1 ? hoveredIndex : 0;
                                      ...
                                      child: draggedIndex == index ? SizedBox() : builtWidget,
                                    ),
                                  ),
                                ),
                              ),
